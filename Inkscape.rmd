      ...
      <div style="display: flex; align-items: flex-start;">
        ...
        <div>
          <ul style="list-style-type: disc; padding-left: 20px;">
            ...
            <li style="margin-bottom: 10px;">There are also some useful resources for practicing. I like <a href="https://bezier.method.ac/" target="_blank">this game</a>, it is designed for Illustrator so the controls are slightly different, but the tool functions the same.</li>
          </ul>
        </div>
      </div>
    </div>
