...
svg("filepath/FakeTree.svg", width = 7, height = 5) # open graphics device that directs all plotting commands to an SVG file
plot(tree)
dev.off() # close the graphics device to write the file
...
download the violin plot [here](https://github.com/KAssersohn/InkscapeTutorial/blob/main/violin_plot.svg)
